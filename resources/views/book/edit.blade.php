        ...
        <h1 class="text-3xl font-bold text-gray-900 flex items-center gap-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M11 5H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2v-5m-9-9l9 9m0 0l-3 3m3-3l-9-9" />
            </svg>
            Edit Book
        </h1>
        ...
        <form action="{{ route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" required
                          class="mt-1 block w-full p-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200">{{ $book->description }}</textarea>
            </div>
            ...
            <div>
                <label for="cover" class="block text-sm font-medium text-gray-700 flex items-center gap-1">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500" fill="none"
                         viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M3 5h18M3 19h18M7 10l5 5 5-5" />
                    </svg>
                    Cover Image
                </label>
            ...
            <div>
                <img src="{{ asset('Uploads/' . $book->cover) }}" alt="Book Cover"
                     class="w-28 h-auto rounded shadow mt-2 transition duration-300 hover:scale-105">
            </div>
